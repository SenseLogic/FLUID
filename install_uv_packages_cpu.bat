...
uv pip install --python ".venv\Scripts\python.exe" --upgrade ffmpeg-python opencv-python tqdm numpy --index-url https://pypi.org/simple --extra-index-url https://download.pytorch.org/whl/cpu
